...
public enum Claude {
    ...
    /// Muted text for timestamps, metadata (#9A9A9F)
    static let textMuted = Color(red: 0.604, green: 0.604, blue: 0.624)
    /// Disabled/dimmed text (#6E6E73)
    static let textDisabled = Color(red: 0.431, green: 0.431, blue: 0.451)
    /// Hint text (38% white) - for ScreenHint and micro labels
    static let textHint = Color.white.opacity(0.38)
